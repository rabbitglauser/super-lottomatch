...
function LandingLink({ href, children, variant }: LandingLinkProps) {
  return (
    <Link
      href={href}
      className={cn(
        "inline-flex h-[58px] items-center justify-center rounded-[1.15rem] px-6 text-sm font-semibold transition duration-200 sm:text-base",
        variant === "primary"
            ...
            <section className="mx-auto w-full max-w-5xl text-center">
              <div className="space-y-5 sm:space-y-6">
                ...
                <p className="mx-auto max-w-[22rem] text-sm leading-7 text-muted-warm sm:max-w-2xl sm:text-base md:max-w-3xl">
                  SuperLottomatch brings guest management, imports, check-ins
                  and prize moments into one polished event flow that feels
                  clear, fast and memorable.
                </p>
              </div>
              ...
              <div className="mt-7 flex flex-col items-stretch justify-center gap-3 sm:mt-8 sm:flex-row sm:flex-wrap">
                ...
                <LandingLink href="/mobile" variant="secondary">
                  Signup
                </LandingLink>
              </div>
            </section>
