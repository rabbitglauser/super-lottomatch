...
-- USERS
-- =========================
-- Development login credentials for seeded users:
-- - nina.odermatt@stv-ennetbuergen.ch / admin-1234
-- - marco.bucher@stv-ennetbuergen.ch / member-1234
-- - sabrina.hess@stv-ennetbuergen.ch / member-1234
-- - lukas.wyrsch@stv-ennetbuergen.ch / inactive-1234 (inactive account)
